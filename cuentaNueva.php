...
if (isset($_POST['nombre']) && $_POST['nombre'] !== '' && isset($_POST['saldo'])) {
    if($_POST['tipo'] === "ca") {
        $cuenta = new CajaAhorro(rand(1000, 9999), $_POST['nombre'], (int) $_POST['saldo'],"+".$_POST['saldo']);
    }
    elseif ($_POST['tipo'] === "cc" ) {
        $cuenta = new CuentaCorriente(rand(1000, 9999), $_POST['nombre'], (int) $_POST['saldo'],"+".$_POST['saldo']);
    }
    else {
